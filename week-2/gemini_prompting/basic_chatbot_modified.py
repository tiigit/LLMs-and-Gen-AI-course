...
prompts.read('prompts_modified.env')

# Set system prompt
persona_prompt = prompts.get("SYSTEM_PROMPTS", "BANANA_LOVER")
# task_prompt = f'Plan a budget for a business trip, you are in charge of the {prompts.get("TEMPLATES", "DOMAIN")}, \
#                return the plan written in {prompts.get("TEMPLATES", "NUMBER")} bullet points.'
...
# My system prompts:
system_prompt = persona_prompt #+ task_prompt
